...
| → | `0x3000` | `00` | 完了通知 |
| ← | `0xB000` | `0000` / `0001` | 受理。測定データがあるときは `0001` |
| → | `0x3010` | `01` | **測定結果の取得** |
| ← | `0xB010` | 87 バイト（TLV） | **測定結果** |
| → | `0x0001` | `00` | セッション終了 |
| ← | `0x8001` | `0000` | 受理 |
...
```text
  ...
  → 0x3000 00              ← 0xB000 0001   payload が 0001 になる
...
未解析。体組成値のデコードで扱う。`0xB010` の 87 バイトに `60 21` `60 22` `60 23` `60 24`
`60 25` `60 27` `60 28` `60 29` `60 2F` `60 5A` `60 77` `60 7D` `61 4B` `61 4C` `6F 21` `6F 22`
といった tag が並ぶ。
